 ...
 * {@link com.gratex.oomph.task.server.TomcatServerTask} object. <!--
...
public class TomcatServerTaskItemProvider extends ServerItemProvider {
	...
	protected void addJreVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TomcatServerTask_jreVersion_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TomcatServerTask_jreVersion_feature",
								"_UI_TomcatServerTask_type"),
						ServerPackage.Literals.TOMCAT_SERVER_TASK__JRE_VERSION, true, false, false,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TomcatServerTask_port_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TomcatServerTask_port_feature",
								"_UI_TomcatServerTask_type"),
						ServerPackage.Literals.TOMCAT_SERVER_TASK__PORT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addHttpsPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TomcatServerTask_httpsPort_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TomcatServerTask_httpsPort_feature",
								"_UI_TomcatServerTask_type"),
						ServerPackage.Literals.TOMCAT_SERVER_TASK__HTTPS_PORT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addServerVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TomcatServerTask_serverVersion_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TomcatServerTask_serverVersion_feature",
								"_UI_TomcatServerTask_type"),
						ServerPackage.Literals.TOMCAT_SERVER_TASK__SERVER_VERSION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addLaunchProgramArgsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_TomcatServerTask_launchProgramArgs_feature",
						"_UI_TomcatServerTask_type"),
				ServerPackage.Literals.TOMCAT_SERVER_TASK__LAUNCH_PROGRAM_ARGS, true, true, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addLaunchVmArgsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TomcatServerTask_launchVmArgs_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TomcatServerTask_launchVmArgs_feature",
								"_UI_TomcatServerTask_type"),
						ServerPackage.Literals.TOMCAT_SERVER_TASK__LAUNCH_VM_ARGS, true, true, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns TomcatServerTask.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 *
	 * @generated
	 */
