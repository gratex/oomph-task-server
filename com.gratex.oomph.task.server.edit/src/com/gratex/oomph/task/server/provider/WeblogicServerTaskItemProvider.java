 ...
 * {@link com.gratex.oomph.task.server.WeblogicServerTask} object. <!--
...
public class WeblogicServerTaskItemProvider extends ServerItemProvider {
	...
	protected void addJreVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_WeblogicServerTask_jreVersion_feature",
						"_UI_WeblogicServerTask_type"),
				ServerPackage.Literals.WEBLOGIC_SERVER_TASK__JRE_VERSION, true, false, false,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WeblogicServerTask_port_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_WeblogicServerTask_port_feature",
								"_UI_WeblogicServerTask_type"),
						ServerPackage.Literals.WEBLOGIC_SERVER_TASK__PORT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addHttpsPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WeblogicServerTask_httpsPort_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_WeblogicServerTask_httpsPort_feature",
								"_UI_WeblogicServerTask_type"),
						ServerPackage.Literals.WEBLOGIC_SERVER_TASK__HTTPS_PORT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addDebugPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WeblogicServerTask_debugPort_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_WeblogicServerTask_debugPort_feature",
								"_UI_WeblogicServerTask_type"),
						ServerPackage.Literals.WEBLOGIC_SERVER_TASK__DEBUG_PORT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Username feature. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 *
	 * @generated
	 */
	protected void addUsernamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WeblogicServerTask_username_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_WeblogicServerTask_username_feature",
								"_UI_WeblogicServerTask_type"),
						ServerPackage.Literals.WEBLOGIC_SERVER_TASK__USERNAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addPasswordPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WeblogicServerTask_password_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_WeblogicServerTask_password_feature",
								"_UI_WeblogicServerTask_type"),
						ServerPackage.Literals.WEBLOGIC_SERVER_TASK__PASSWORD, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns WeblogicServerTask.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @generated
	 */
