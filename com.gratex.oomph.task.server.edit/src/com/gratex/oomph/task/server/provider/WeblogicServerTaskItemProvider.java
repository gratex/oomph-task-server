 ...
 * @generated
 */
public class WeblogicServerTaskItemProvider extends SetupTaskItemProvider
{
  /**
  ...
  protected void addServerNamePropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_WeblogicServerTask_serverName_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_WeblogicServerTask_serverName_feature", "_UI_WeblogicServerTask_type"),
        ServerPackage.Literals.WEBLOGIC_SERVER_TASK__SERVER_NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_WeblogicServerTask_location_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_WeblogicServerTask_location_feature", "_UI_WeblogicServerTask_type"),
        ServerPackage.Literals.WEBLOGIC_SERVER_TASK__LOCATION, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_WeblogicServerTask_runtimeName_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_WeblogicServerTask_runtimeName_feature", "_UI_WeblogicServerTask_type"),
        ServerPackage.Literals.WEBLOGIC_SERVER_TASK__RUNTIME_NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_WeblogicServerTask_hostname_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_WeblogicServerTask_hostname_feature", "_UI_WeblogicServerTask_type"),
        ServerPackage.Literals.WEBLOGIC_SERVER_TASK__HOSTNAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
