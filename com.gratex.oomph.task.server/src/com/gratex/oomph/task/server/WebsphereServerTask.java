 ...
 * '<em><b>Websphere Server Task</b></em>'. <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link com.gratex.oomph.task.server.WebsphereServerTask#getBaseServerName
 * <em>Base Server Name</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.WebsphereServerTask#getProfilePath
 * <em>Profile Path</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.WebsphereServerTask#getProfileName
 * <em>Profile Name</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.WebsphereServerTask#getBootstrapPort
 * <em>Bootstrap Port</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.WebsphereServerTask#getIcpPort
 * <em>Icp Port</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.WebsphereServerTask#getSoapPort
 * <em>Soap Port</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.WebsphereServerTask#getRemoteOsUser
 * <em>Remote Os User</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.WebsphereServerTask#getRemoteOsPassword
 * <em>Remote Os Password</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.WebsphereServerTask#getServerVersion
 * <em>Server Version</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.WebsphereServerTask#getSecurityUserId
 * <em>Security User Id</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.WebsphereServerTask#getSecurityUserPassword
 * <em>Security User Password</em>}</li>
 * </ul>
 *
 ...
 *        variableName='p2.server'
 *        repository='https://gratex.github.io/oomph-task-server/repository/'
...
public interface WebsphereServerTask extends Server {
	/**
	 * Returns the value of the '<em><b>Base Server Name</b></em>' attribute. The
	 * default value is <code>"server1"</code>. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * <em>Base Server Name</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Profile Path</em>' attribute isn't clear, there
	 ...
	 * <em>Profile Path</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 *
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Profile Name</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	 ...
	 * <em>Profile Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 *
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Bootstrap Port</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	 ...
	 * <em>Bootstrap Port</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Icp Port</em>' attribute isn't clear, there really
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Soap Port</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Remote Os User</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	 ...
	 * <em>Remote Os User</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 ...
	 * <em>Remote Os Password</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	...
	/**
	 * Returns the value of the '<em><b>Server Version</b></em>' attribute. The
	 * literals are from the enumeration
	 * {@link com.gratex.oomph.task.server.WebsphereServerVersion}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Server Version</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	 ...
	 * <em>Server Version</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 ...
	 * <em>Security User Id</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Security User Password</em>' attribute isn't
	 ...
	 * <em>Security User Password</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @param value the new value of the '<em>Security User Password</em>'
	 *              attribute.
