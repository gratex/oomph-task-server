 ...
 * </p>
 * <ul>
 * <li>{@link com.gratex.oomph.task.server.Server#getServerName <em>Server
 * Name</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.Server#getLocation
 * <em>Location</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.Server#getRuntimeName <em>Runtime
 * Name</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.Server#getHostname
 * <em>Hostname</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.Server#isCleanPreviousRuntimes
 * <em>Clean Previous Runtimes</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.Server#getStartTimeout <em>Start
 * Timeout</em>}</li>
 * <li>{@link com.gratex.oomph.task.server.Server#getStopTimeout <em>Stop
 * Timeout</em>}</li>
 * </ul>
 *
...
public interface Server extends SetupTask {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Server Name</em>' attribute isn't clear, there
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Location</em>' attribute isn't clear, there really
	...
	/**
	 * Sets the value of the '{@link com.gratex.oomph.task.server.Server#getLocation
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Runtime Name</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	...
	/**
	 * Returns the value of the '<em><b>Hostname</b></em>' attribute. The default
	 * value is <code>"localhost"</code>. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Hostname</em>' attribute isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	...
	/**
	 * Sets the value of the '{@link com.gratex.oomph.task.server.Server#getHostname
	 ...
	 * <p>
	 * If the meaning of the '<em>Clean Previous Runtimes</em>' attribute isn't
	 ...
	 * Previous Runtimes</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 *
	 * @param value the new value of the '<em>Clean Previous Runtimes</em>'
	 *              attribute.
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Start Timeout</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	 ...
	 * Timeout</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Stop Timeout</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
